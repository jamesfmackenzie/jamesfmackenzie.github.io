...
summary: Hardware overview of the original Sony PlayStation and why it remains one of the most important and enjoyable 32-bit consoles.
...
- memory cards
- specialist accessories such as the **[PlayStation Mouse]({% link _hardware/playstation-mouse.md %})**
- specialist controllers such as the **[Namco NeGcon]({% link _hardware/namco-negcon.md %})**
