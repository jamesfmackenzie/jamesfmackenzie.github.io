---
layout: post
title: Using Parallel Cable and PARCP-USB to Transfer Files from PC to ST
...
![](/img/parcp-usb_adapter_dongle.jpg "The PARCP-USB adapter")
...
![](/img/parcp-usb_parallel_port.jpg "PARCP-USB parallel connector")

![](/img/parcp-usb_mini_usb_port.jpg "PARCP-USB mini USB connector")
...
![](/img/parcp_parserve_tos.png "Launch PARSERVE.TOS")
...
![](/img/parcp_exe.png "Launch parcp.exe")
...
![](/img/parcp_server.png "PARCP server received connection")

![](/img/parcp_client.png "PARCP client")
...
![](/img/parcp_client_file_selected.png "PARCP client - press spacebar to select a file")
...
![](/img/parcp_confirmation_dialog.png "Copy file(s)? Yes / No")

![](/img/parcp_progress_bar.png "A progress bar will report on your file transfer")
...
![](/img/parcp_transferred_file.png "File Transfer Success!")
