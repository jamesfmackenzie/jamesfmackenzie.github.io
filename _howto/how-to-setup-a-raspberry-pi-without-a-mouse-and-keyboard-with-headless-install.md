...
![Download Rasbian](/img/2017-01-02 17_28_22-Download Raspbian for Raspberry Pi.png)
...
![Write the Rasbian image using Win32DiskImager](/img/2017-01-02 14_22_43-Rasbian Win32 Disk Imager.png)
...
![ssh file](/img/2017-01-02 14_27_37-ssh-file.png)

### Step 4. Boot your Pi

Pop your prepared SD card, power and a network cable into the Pi.

![Raspberry Pi, powered up and ready to go](/img/raspberry-pi.jpg)
...
![DHCP lease allocation table](/img/2017-01-02 14_40_16-raspberry-pi-ip-address.png)
...
![SSH into your Pi](/img/2017-01-02 14_40_39-ssh-into-your-pi.png)
...
![Invoke raspi-config](/img/2017-01-02 14_47_57-sudo-raspi-config.png)

![raspi-config](/img/2017-01-02 14_48_05-raspi-config.png)