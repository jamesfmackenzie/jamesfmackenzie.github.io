---
layout: post
title: Using SD card and Ultrasatan to Transfer Files from PC to ST
...
![](/img/atari_st_win32diskimager_a.png "Select a disk image")
...
![](/img/atari_st_win32diskimager_b.png "Click 'Write'")

![](/img/atari_st_win32diskimager_c.png "Ensure you have the correct volume")
...
![](/img/atari_st_win32diskimager_d.png "Write successful")

![](/img/atari_st_win32diskimager_e.png "Files are readable using Windows Explorer")
...
![](/img/atari_st_ultrasatan_boot.png "Ultrasatan boot")

![](/img/atari_st_ultrasatan_ramdisk.png "Ultrasatan ramdisk")
...
![](/img/atari_st_ultrasatan_partitioning_1.png "Ultrasatan partitioning 1")

* Increase the size of the <code>C:</code> drive from 14MB to 511MB (or 255MB if you're running TOS 1.02 or lower)

![](/img/atari_st_ultrasatan_partitioning_2.png "Ultrasatan partitioning 2")
...
![](/img/atari_st_ultrasatan_partitioning_3.png "Ultrasatan partitioning 3")
...
![](/img/atari_st_ultrasatan_partitioning_drives.png "Partitioning drives")
...
![](/img/atari_st_ultrasatan_install_disk_drive_1.png "Installing a new drive")

* Set the <code>Drive identifier</code> to "D:"

![](/img/atari_st_ultrasatan_install_disk_drive_2.png "Setting the new drive letter")

* Repeat the process for any other new drives you have

* Save the Desktop via <code>Options -> Save Desktop</code>

![](/img/atari_st_ultrasatan_save_desktop.png "Save Desktop")
...
![](/img/atari_st_ultrasatan_sd_card_properties.png "Ultrasatan SD card")

* In Windows Explorer, Drag and drop some files onto the SD card

![](/img/atari_st_ultrasatan_sd_card_copied_files.png "Drag & Drop some files onto the SD card")
...
![](/img/atari_st_ultrasatan_atari_st_copied_files.png "Copied files, available on the ST!")
