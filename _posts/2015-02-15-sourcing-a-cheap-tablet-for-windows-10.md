...
As [mentioned recently]({% post_url 2015-02-18-install-windows-10-technical-preview-on-tesco-tablet %}), I want to find a cheap tablet to try the Windows 10 Technical Preview on. Which one to choose?
