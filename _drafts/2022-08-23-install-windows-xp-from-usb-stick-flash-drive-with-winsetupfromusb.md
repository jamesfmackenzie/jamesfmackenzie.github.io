...
date: '2022-08-25 12:22:00:00'
summary: How can you install Windows XP with no CD drive? Here's how ...
tags: [How To, Retrocomputing, Retrogaming, Windows XP]
---

How can you install Windows XP on a system with no CD drive? Can you install from USB? Here's how to do it.

This is a super useful tool that can prepare a USB flash drive to install any Windows versions since 2000/XP.
...
First, insert the USB stick into your PC and format as NTFS.

![](/img/posts/usb-stick-flash-drive-formatted-ntfs.png)


### Step 2 - Download and install WinSetupFromUSB
...
### Step 3 - Prepare USB install media
