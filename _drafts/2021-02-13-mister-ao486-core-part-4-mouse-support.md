---
layout: post
title: "MiSTer AO486 Core Part 4 - Mouse Support"
...
You have the ao486 core setup with DOS. You have file sharing enabled via MiSTerFS. Next up you need mouse support!

1. Download cutemouse

2. Copy via misterfs

3. Add to config.sys / autoexec.bat

4. Test it out

5. play some games! (Monkey Island)
