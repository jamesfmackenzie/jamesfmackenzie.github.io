---
layout: post
title: "MiSTer AO486 Core Part 3 – Adding CD-ROM Support"
...
or ... just download manually and use misterFS (probay best)
...
copy the following files from misterFS to hard disk:
