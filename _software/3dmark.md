...
It grew out of [Final Reality]({% link _software/final-reality.md %}), the Remedy Entertainment benchmark from 1997 that I have real memories of running on a 3D Rage Pro, an Intel i740, and a 3dfx Voodoo 2. 3DMark is the direct successor to that lineage, and it's still what I run on retro builds like the [Dell OptiPlex 760]({% link _hardware/dell-optiplex-760.md %}) to get a real, comparable number rather than just a vibe.

### Related on this site

- [The History of (and Nostalgia for) 3DMark]({% post_url 2023-04-21-the-history-of-and-nostalgia-for-futuremark-3dmark %})
- [Final Reality]({% link _software/final-reality.md %})
- [Dell OptiPlex 760]({% link _hardware/dell-optiplex-760.md %})
