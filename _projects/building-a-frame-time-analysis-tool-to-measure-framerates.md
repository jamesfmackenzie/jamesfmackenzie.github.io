---
layout: post
title: Building a Frame-Time Analysis Tool
date: '2022-04-02 12:00:00'
tags: [Programming, Projects]
status: in progress
---

Inspired by <a href="https://www.youtube.com/user/DigitalFoundry" target="_blank">Digital Foundry</a>, <a href="https://www.youtube.com/c/VGTech" target="_blank">VG Tech</a> and <a href="https://www.youtube.com/c/NXGamer" target="_blank">NX Gamer</a>, I wanted to deep-dive on videogame technical analysis — and more precisely write my own frame-time analysis tool.

I set myself the following goals:

1. **Write my own frame-time analysis tool**. To look at captured videogame footage and analyze framerate, torn frames, resolution etc
...
Status | On hold
Goal | Build my own "Digital Foundry" frame-time analysis tool

After some background research, I selected <a href="https://opencv.org/" target="_blank">OpenCV</a> as the foundational project library. As a specialised framework for computer vision and image analysis, it's a great fit.
...
* Hypothesis: because video frames from a 3D engine are temporally connected, we would *usually* expect frame difference trend to be relatively consistent between frames. Significant trend divergence is aberration - and might indicate a frame drop.
