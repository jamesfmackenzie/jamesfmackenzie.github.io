---
layout: post
title: Building a Retro Rocket PC on the Cheap
...
After some research, I picked up a cheap and old business machine — a [Dell Optiplex 380]({% link _hardware/dell-optiplex-380.md %}) — for only $60 shipped.
...
- [Dell OptiPlex 380 hardware overview]({% link _hardware/dell-optiplex-380.md %})
